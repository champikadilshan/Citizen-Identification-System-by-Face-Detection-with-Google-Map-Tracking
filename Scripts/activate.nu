...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\dilshan\PycharmProjects\FaceRecognitionRealTimeDataBase'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\dilshan\PycharmProjects\FaceRecognitionRealTimeDataBase\Scripts\deactivate.nu'
